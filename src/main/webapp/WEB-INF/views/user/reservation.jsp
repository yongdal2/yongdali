					...
					<div id="line2">
						<div class="edge11">
							...
							<div id="startAddr-div" class="content22">
								...
								<div align="left">
									<label id="start-check" class="checkbox-wrap" style="height: 18px; margin-bottom: 2px;">
								...
								<div>
									...
									<div id="caution-div2" style="display: none; color:red; height: 17px; padding: 0px; margin-bottom: 3px; font">
										<small>* 상차일 예약시, 다음날부터 예약이 가능하십니다. *</small>
									</div>
									<div style="display: flex;">
						...
						<div class="edge11">
							...
							<div id="endAddr-div" class="content22">
								...
								<div style="display: block;">
									<div id="caution-div3" style="display: block; height: 17px; margin-bottom: 3px;"></div>
									<div id="caution-div4" style="display: none; color:red; height: 17px; padding: 0px; margin-bottom: 3px; font">
										<small>* 상차일 기준으로 다음날부터 예약이 가능하십니다.*</small>
									</div>
									<div id="caution-div5" style="display: none; color:red; height: 17px; padding: 0px; margin-bottom: 3px; font">
