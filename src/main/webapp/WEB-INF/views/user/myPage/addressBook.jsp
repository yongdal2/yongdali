...
<head>
	...
	<script src="${pageContext.request.contextPath}/resources/js/myPage/userMyPage.js"></script>
...
<body>
                    ...
                    <div class="col-xs-12 col-md-12">
                        ...
                        <div class="row small" style="border-bottom: 1px solid #dedede; padding: 10px;">
                            ...
                            <div class="col-xs-5 col-md-5">
                                <span>06203</span> <span>강남구 대치동 123-556로 24번지</span>
                                <br>
                                <span>123층 12호</span>
                            </div>
                            <div class="col-xs-2 col-md-2">
                            ...
                            <div class="col-xs-3 col-md-3">
                                <button class="btn btn-sm btn_ydl" data-toggle="modal" data-target="#addrEdit">수정</button>
                ...
                <div class="modal-body noto mb_pd" style="padding-top: 0px">
                    <div class="row  text-left center-block" style="border: 1px solid #dedede; border-radius: 16px; padding: 23px; background: #fff; width: 100%; max-width: 420px;">
                        ...
                        <div class="row text-left" style="padding-left: 23px; padding-bottom: 5px;">
                            ...
                            <div class="col-xs-3 col-md-3" style="padding: 0; margin-top: 10px;">
                                <input type="text" class="form-control noto" id="adAdr_postcode" style="width: 100%; height: 35px;" placeholder="우편번호">
                            </div>
                        ...
                        <div class="row text-left" style="padding-left: 23px; padding-bottom: 5px;">
                            ...
                            <div class="col-xs-8 col-md-8" style="padding: 0; margin-top: 10px;">
                                <input type="text" class="form-control noto" id="sample3_detailAddress" style="width: 100%; height: 35px;" placeholder="상세주소를 입력해 주세요.">
                            </div>
                        </div>
                        <div class="row text-left" style="padding-left: 23px; padding-bottom: 5px;">
                            <div class="col-xs-3 col-md-3" style="padding: 0; margin-top: 16px; font-size: 14px; line-height: 24px;">
   ...
   <!--  <div class="modal fade" id="addrEdit" role="dialog">
        <div class="modal-dialog">
            ...
            <div class="modal-content center-block" style="max-width: 440px;">
                <br>
                <div class="modal-body noto mb_pd" style="padding-top: 0px; padding-bottom: 21px;">
                    <div class="row text-left" style="margin: 0; border: 1px solid #dedede; border-radius: 16px; padding: 23px; background: #fff; width: 100%; max-width: 420px;">
                        <div class="row">
                            <div class="col-xs-12 col-md-12 fw6" style="padding-right: 23px; font-size: 18px; font-weight: 600;">
								 배송지 정보 상세
                                <button type="button" class="close" data-dismiss="modal">&times;</button>
                        ...
                        <div class="row text-left" style="padding-left: 23px; padding-bottom: 5px;">
                            ...
                            <div class="col-xs-5 col-md-5" style="padding: 0; margin-top: 10px;">
                                <input type="text" class="form-control noto" id="#1" style="width: 100%; height: 35px;">
                            </div>
                        </div>

                        <div class="row text-left" style="padding-left: 23px; padding-bottom: 5px;">
                            <div class="addr_lb1 col-xs-3 col-md-3" style="padding: 0; margin-top: 16px; font-size: 14px; line-height: 24px;">
								수령인<span class="red"> *</span>
                            </div>
                            <div class="col-xs-5 col-md-5" style="padding: 0; margin-top: 10px;">
                                <input type="text" class="form-control noto" id="#2" style="width: 100%; height: 35px;">
                            </div>
                        </div>
                        <div class="row text-left" style="padding-left: 23px; padding-bottom: 5px;">
                            <div class="col-xs-3 col-md-3" style="padding: 0; margin-top: 16px; font-size: 14px; line-height: 24px;">
                            ...
                            <div class="col-xs-3 col-md-3" style="padding: 0; margin-top: 10px;">
                                <input type="text" class="form-control noto" id="sample3_postcode" style="width: 100%; height: 35px;">
                            </div>
                            <div class="col-xs-2 col-md-2 btn btn_ydl_l" style="padding: 0; margin-top: 10px; height: 35px; line-height: 35px;" onclick="sample3_execDaumPostcode()">
								주소 검색
							</div>
                        </div>
                        <div class="row text-left" style="padding-left: 23px; padding-bottom: 5px;">
                            ...
                            <div class="col-xs-8 col-md-8" style="padding: 0; margin-top: 10px;">
                                <input type="text" class="form-control noto" id="sample3_address" style="width: 100%; height: 35px;">
                            </div>
                        </div>
                        <div class="row text-left" style="padding-left: 23px; padding-bottom: 5px;">
                            <div class="col-xs-3 col-md-3" style="padding: 0; margin-top: 16px; font-size: 14px; line-height: 24px;">
                        ...
                        <div class="col-xs-12 col-md-12" id="pwCheckText" style="padding: 0; margin-top: 5px; display: none;"></div>
							...
							<div class="col-xs-12 col-md-12 text-center">
								...
								<button type="submit" class="btn btn_ydl" data-dismiss="modal"
									style="margin: 20px 10px 0px 10px;">수정하기</button>
							</div>
						</div>
					</div>
            </div>
    ...
    <!-- 배송지 주소 추가 주소 검색 모달 -->
	<div class="modal fade" id="adSearchAddr" role="dialog">
		<div class="modal-dialog">
			<!-- Modal content -->
			<div class="modal-content center-block" style="max-width: 440px;">
			 <div id="layer">
	...
	<!-- 배송지 주소 수정 주소 검색 모달 -->
	<div class="modal fade" id="edSearchAddr" role="dialog">
		<div class="modal-dialog">
			<!-- Modal content -->
			<div class="modal-content center-block" style="max-width: 440px;">
			</div>
