...
<body>
    ...
    <div style="display: flex; margin-left: 400px; margin-top:300px">
        ...
        <div OnClick="location.href ='insertSample.me'" style="width: 100px; height: 100px; background: purple; cursor: pointer; border-radius: 10px; margin-right: 20px; color: white;">
            샘플데이터
        </div>
