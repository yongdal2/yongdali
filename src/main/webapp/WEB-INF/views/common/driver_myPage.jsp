	...
	<nav class="navbar navbar-expand navbar-dark mai-top-header" style="margin-bottom: 18px; padding-top: 23px; font-size: 18px;">
		<div class="container">
			...
			<div class="navbar-header col-lg-4">
				<a class="navbar-brand" href="#" style="font-size: 30px; color: #F15F5F; padding-top: 0px;">
					<img alt="사진안들어감"src="${pageContext.request.contextPath}/resources/images/ydl_logo/ydl_lg_red(150X50).png" class="d-inline-block align-top" style="height: 48px">
				</a>
			</div>
			<div class="col-lg-4">
			...
			<div class="col-lg-4">
				<ul class="nav navbar-nav float-lg-right navbar-right">
					<c:if test="${empty sessionScope.loginUser }">
						<li class="nav-item">
							<button class="btn btn-default navbar-btn loginView" style="background: #F15F5F; color: white;">로그인</button>
						</li>
						<li class="nav-item">
