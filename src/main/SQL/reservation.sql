...
Insert into YONGDALI.RESERVATION values ('R4','M4',null,'1','탑차','서울 동작구 동작대로 335-1-초록색 대문','서울 강북구 덕릉로 88,이편한세상 1102동 602호','9.9','010-8362-5111','010-8362-5111',null,'바로 하차',to_date('20/04/23','RR/MM/DD'),'07:30',null,null,'고객님이 직접 상차','고객님이 직접 하차','침대(매트리스만)(2), 침대(매트리스만+프레임)(1), 화장대(1), 책상(1), 모니터(1), 프린터(1), 냉장고(1), TV(1), 공기청정기(1), 청소기(1)',null,'60000','Y',null,null,null,null,to_date('20/04/13','RR/MM/DD'));
Insert into YONGDALI.RESERVATION values ('R5','M1',null,'1','윙바디','남지훈','최진영','서울 용산구 다산로 8-11-놀이터','서울 용산구 한강대로 405,서울역','5.6','010-9955-3215','010-9955-3215',null,'바로 하차',to_date('20/04/14','RR/MM/DD'),'19:30',null,null,'기사님 단독 상차','고객님이 직접 하차','수납장(2), 신발장(2), 화장대(1), 책상(1), 모니터(4), 에어컨(2), 냉장고(2), 공기청정기(3)','냉장고가 조금 무거워요.','80000','Y',null,null,null,null,to_date('20/04/13','RR/MM/DD'));
