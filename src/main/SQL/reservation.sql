...
Insert into YONGDALI.RESERVATION values ('R2','M2',null,'1','카고','박정연','손신혜','010-8651-5515','010-6215-5842','서울 중랑구 동일로 지하 797-아이파크 1102동 202호','서울 강남구 강남대로 238,스카이빌딩 601호','9.3',null,null,to_date('20/05/02','RR/MM/DD'),'04:30',to_date('20/05/06','RR/MM/DD'),'07:00','기사님 단독 상차','기사님과 함께 하차','침대(매트리스만+프레임)(1), 수납장(1), 신발장(1), 화장대(1), 의자(1), 식탁(1), 옷장(1), 모니터(1), 에어컨(1), TV(1), 청소기(1)','저희집 CU 편의점 맞은편에 있습니다.','310000','Y',null,null,null,null,to_date('20/04/13','RR/MM/DD'));
Insert into YONGDALI.RESERVATION values ('R3','M3',null,'1','호루','이탐희','장원태','010-9915-2542','010-8452-5523','서울 서초구 강남대로 27-마당 넓은 집','서울 성북구 동소문로 24길 14-8,하늘마루빌라 301호','11.6','바로 상차','바로 하차',null,null,null,null,'고객님이 직접 상차','고객님이 직접 하차','침대(매트리스만+프레임)(1), 수납장(1), 화장대(1), 프린터(2), 냉장고(2), TV(2), 세탁기(2), 청소기(4)','오실때 물 1리터짜리 6개 한 묶음 부탁드릴게요.','80000','Y',null,null,null,null,to_date('20/04/13','RR/MM/DD'));
Insert into YONGDALI.RESERVATION values ('R4','M4',null,'1','탑차','박정연','박정연','010-8362-5111','010-8362-5111','서울 동작구 동작대로 335-1-초록색 대문','서울 강북구 덕릉로 88,이편한세상 1102동 602호','9.9',null,'바로 하차',to_date('20/04/23','RR/MM/DD'),'07:30',null,null,'고객님이 직접 상차','고객님이 직접 하차','침대(매트리스만)(2), 침대(매트리스만+프레임)(1), 화장대(1), 책상(1), 모니터(1), 프린터(1), 냉장고(1), TV(1), 공기청정기(1), 청소기(1)',null,'60000','Y',null,null,null,null,to_date('20/04/13','RR/MM/DD'));
Insert into YONGDALI.RESERVATION values ('R5','M1',null,'1','윙바디','유승제','유승제','010-9955-3215','010-9955-3215','서울 용산구 다산로 8-11-놀이터','서울 용산구 한강대로 405,서울역','5.6',null,'바로 하차',to_date('20/04/14','RR/MM/DD'),'19:30',null,null,'기사님 단독 상차','고객님이 직접 하차','수납장(2), 신발장(2), 화장대(1), 책상(1), 모니터(4), 에어컨(2), 냉장고(2), 공기청정기(3)','냉장고가 조금 무거워요.','80000','Y',null,null,null,null,to_date('20/04/13','RR/MM/DD'));
Insert into YONGDALI.RESERVATION values ('R6','M2',null,'1','리프트','박정연','손신혜','010-1166-9582','010-6251-7598','서울 용산구 임정로 7,숙명여대','서울 강남구 개포로 402,개포고','11.6','바로 상차',null,null,null,to_date('20/04/24','RR/MM/DD'),'08:00','기사님 단독 상차','기사님 단독 하차','침대(매트리스만)(1), 침대(매트리스만+프레임)(1), 신발장(4), 책상(3), 프린터(1), 냉장고(2), TV(2)','안전하게 배송 부탁드립니다~','780000','Y',null,null,null,null,to_date('20/04/13','RR/MM/DD'));
Insert into YONGDALI.RESERVATION values ('R7','M3',null,'1.4','카고','이탐희','장원태','010-6654-1885','010-8632-1919','서울 성동구 마조로 42,한양대학교 기숙사','서울 관악구 관악로 1,서울대학교 기숙사 1관','11.2',null,null,to_date('20/05/02','RR/MM/DD'),'18:30',to_date('20/05/09','RR/MM/DD'),'07:30','고객님이 직접 상차','고객님이 직접 하차','침대(매트리스만+프레임)(1), 수납장(1), 신발장(1), 화장대(1), 책상(1), 프린터(1), 에어컨(1), 냉장고(1), TV(1)','가는길에 사람좀 태울게요~','490000','Y',null,null,null,null,to_date('20/04/13','RR/MM/DD'));
