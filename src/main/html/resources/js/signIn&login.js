$(document).ready(function(){
    ...
    $('#slecBiz').click(function(){
        if($('#slecBiz img').attr('alt') == '더하기'){
            $('#slecBiz img').attr('src', '../../resources/images/login&siginIn/round-substract.svg').attr('alt','빼기');            
            $('#slecBiz div').text('일반회원으로 가입하기');
            $('.bizForm').show();
        }else{
                $('#slecBiz img').attr('src', '../../resources/images/login&siginIn/round-add.svg').attr('alt','더하기');
    ...
    $('#chkAll').click(function(){
        if($(this).attr('src') == '../../resources/images/login&siginIn/unchecked-circle.png') {
            $('.chkPolicy').attr('src','../../resources/images/login&siginIn/checked-circle.png');
        } else{
            $('.chkPolicy').attr('src','../../resources/images/login&siginIn/unchecked-circle.png');
        }
    });

    $('.chkPolicy:eq(1)').click(function(){
        if($(this).attr('src') == '../../resources/images/login&siginIn/unchecked-circle.png') {
            $(this).attr('src','../../resources/images/login&siginIn/checked-circle.png');
        } else{
            $(this).attr('src','../../resources/images/login&siginIn/unchecked-circle.png');
        }
    });
